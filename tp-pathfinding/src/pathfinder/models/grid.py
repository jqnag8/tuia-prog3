...
class Grid:
    ...
    def manhattan(self, node_state: tuple[int, int])->int:
        """Get the distance between the goal and the node state"""

        dx:int= abs(node_state[0]-self.end[0])
        dy:int= abs(node_state[1]-self.end[1])
